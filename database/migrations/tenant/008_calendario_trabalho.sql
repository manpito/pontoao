DROP TABLE IF EXISTS anos_laborais;
...
VALUES
    ('periodo_dia_inicio', '21', 'Dia do mês em que começa o período de contagem mensal'),
    ('periodo_dia_fim',    '20', 'Dia do mês em que termina o período de contagem mensal');

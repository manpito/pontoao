...
$app->group('/api', function (\Slim\Routing\RouteCollectorProxy $group) {
    ...
    // --- Funcionários ---
    $group->get('/funcionarios/proximo-numero', [\App\Controllers\FuncionarioController::class, 'proximoNumero'])
...
$group->get('/relatorios/periodo/exportar',            [\App\Controllers\RelatorioController::class, 'exportarPeriodo'])
    ...
    $group->get('/terminais/{id}/agent-download',         [\App\Controllers\TerminalController::class, 'downloadAgente'])
          ->add(AuthMiddleware::role(['super_admin_tenant', 'rh_manager']));

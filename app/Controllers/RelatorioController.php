...
class RelatorioController
{
    ...
    private function exportarExcel(array $dados, string $tipo, string $filename, ResponseInterface $response): ResponseInterface
    {
        ...
        if ($tipo === 'assiduidade' || $tipo === 'departamento') {
            ...
            $sheet->fromArray(['Funcionário', 'Nº Dias Trabalhados', 'Nº Horas Trabalhadas', 'Nº Meio Dia', 'Nº Horas Meio Dia', 'Nº Horas Extra', 'Dias Férias', 'Nº de Faltas'], NULL, 'A5');
    ...
    private function exportarCSV(array $dados, string $tipo, string $filename, ResponseInterface $response): ResponseInterface
    {
        ...
        if ($tipo === 'assiduidade') {
            ...
            fputcsv($output, ['Funcionário', 'Nº Dias Trabalhados', 'Nº Horas Trabalhadas', 'Nº Meio Dia', 'Nº Horas Meio Dia', 'Nº Horas Extra', 'Dias Férias', 'Nº de Faltas'], ';');
            foreach ($dados as $r) {
                fputcsv($output, [
                    $r['funcionario_nome'],
                    $r['dias_trabalhados'],
